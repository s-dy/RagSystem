...
if __name__ == '__main__':
    ...
    # 查询和检索到的文档
    query = "黄独分布在哪些地区？"
    retrieved_docs= ['黄独（学名：）为薯蓣科薯蓣属的植物。多年生缠绕藤本。地下有球形或圆锥形块茎。叶腋内常生球形或卵圆形珠芽，大小不一，外皮黄褐色。心状卵形的叶子互生，先端尖锐，具有方格状小横脉，全缘，叶脉明显，7-9条，基出；叶柄基部扭曲而稍宽，与叶片等长或稍短。夏秋开花，单性，雌雄异株，穗状花序丛生。果期9-10月。分布于大洋洲、朝鲜、非洲、印度、日本、台湾、缅甸以及中国的江苏、广东、广西、安徽、江西、四川、甘肃、云南、湖南、西藏、河南、福建、浙江、贵州、湖北、陕西等地，生长于海拔300米至2,000米的地区，多生于河谷边、山谷阴沟或杂木林边缘，目前尚未由人工引种栽培。在美洲也可发现其踪迹，对美洲而言是外来种，有机会在农田大量繁殖，攀上高树争取日照。英文别名为air potato。黄药（本草原始），山慈姑（植物名实图考），零余子薯蓣（俄、拉、汉种子植物名称），零余薯（广州植物志、海南植物志），黄药子（江苏、安徽、浙江、云南等省药材名），山慈姑（云南楚雄）', '草黄树鸭（学名：\"\"）是分布在热带地区的树鸭属，包括中美洲、南美洲、撒哈拉以南非洲、印度次大陆及美国墨西哥湾沿岸地区。草黄树鸭长48-53厘米。牠们的喙是灰色的，头部及脚都很长，头部及上身呈浅黄色，两侧有些红色，冠深色，背部及双翼呈深灰色。尾巴及双翼上有栗褐色的斑纹，上尾有一白色的半月形，在飞时特别明显。雏鸟两侧对比较低，尾巴颜色也有不同。草黄树鸭很普遍。除了一些地区性的移动外，很多时都是留鸟，而在南欧也会有一些流浪者。牠们会在树枝上筑巢，有时也会在空心树中筑巢或利用其他鸟类的巢。牠们每次会生8-12只蛋。草黄树鸭喜欢栖息在淡水湖、稻田或水塘。牠们多在夜间觅食，主要吃种子及植物的其他部份。草黄树鸭是群居的，可以组成一大群。草黄树鸭是《非洲-欧亚大陆迁徙水鸟保护协定》所保护的物种之一。', '黄喉拟水龟（学名：、）又称柴棺龟、石金钱龟，为泽龟科拟水龟属的爬行动物。分布于中国的安徽、云南、海南、河南、广东、贵州、江西、浙江、福建、广西、香港及越南北部，台湾，日本波照间岛、西表岛、石垣岛及与那国岛，生活于低海拔地区的河流、湖泊等。头部为绿色，有黄色带状纹，上颌橄榄色，下颌黄色；背甲长12～14公分；有三条脊棱，中央一条发达，两侧常不明显，后缘呈锯齿状，灰褐色背面，黄色腹面，散步四角形的黑斑，四肢为橄榄色，具有绿色纵走带状纹；趾间具蹼。材棺龟体格强健，杂食性但偏好肉食，水陆两栖，但较喜欢在水边活动，食物包括叶菜、蟋蟀、面包虫、,鱼虾等。生性胆怯，但略具攻击性，会因为争食而攻击同类或其他龟类，有夜行倾向。雄性尾部粗大，泄殖孔超过背甲边缘，雌龟则尾部细短，泄殖孔距躯体较近。雌龟大于雄龟，每年可产卵1-3次，每次下1-5颗蛋，约65-80天孵化。冬天温度低于20度以下时活动会逐渐减少，最后进入冬眠状态。常见于丘陵地带半山区的山间盆地或河流谷地的水域中，常于附近的小灌丛或草丛中。性情害羞，夜行性乌龟。该物种的模式产地在浙江舟山群岛。在台湾普遍称为「柴棺龟」。', '黄尾魣（学名：），又称黄尾金梭鱼，俗名针梭、竹梭，为辐鳍鱼纲鲈形目鲭亚目金梭鱼科的其中一种。本鱼分布于印度西太平洋区，包括东非、红海、模里西斯、阿曼、印度、泰国、圣诞岛、可可群岛、马来西亚、日本、台湾、越南、印尼、菲律宾、巴布亚纽几内亚、香港、澳洲、马里亚纳群岛、新喀里多尼亚、关岛、萨摩亚群岛、东加等海域。该物种的模式产地在红海。水深3至50公尺。本鱼体延长呈鱼雷状，横切面几近圆柱形，侧线直而不弯曲；尾鳍深分叉，胸鳍末端达第一背鳍起点，腹鳍起点远前于第一背鳍起点。鳃盖具一尖棘，上颔骨远前于眼前缘。背部暗绿色，腹部银白色，尾鳍镶黑边，在侧线下具一暗色纵带，背鳍硬棘6枚；背鳍软条9枚；臀鳍硬棘2枚；臀鳍软条9枚，体长可达60公分。本鱼常成群地在礁湖或向海礁区的上方游走，属肉食性，以鱼类为食。为食用鱼，适合各种烹调方式。', '黄独（学名：）为薯蓣科薯蓣属的植物。多年生缠绕藤本。地下有球形或圆锥形块茎。叶腋内常生球形或卵圆形珠芽，大小不一，外皮黄褐色。心状卵形的叶子互生，先端尖锐，具有方格状小横脉，全缘，叶脉明显，7-9条，基出；叶柄基部扭曲而稍宽，与叶片等长或稍短。夏秋开花，单性，雌雄异株，穗状花序丛生。果期9-10月。分布于大洋洲、朝鲜、非洲、印度、日本、台湾、缅甸以及中国的江苏、广东、广西、安徽、江西、四川、甘肃、云南、湖南、西藏、河南、福建、浙江、贵州、湖北、陕西等地，生长于海拔300米至2,000米的地区，多生于河谷边、山谷阴沟或杂木林边缘，目前尚未由人工引种栽培。在美洲也可发现其踪迹，对美洲而言是外来种，有机会在农田大量繁殖，攀上高树争取日照。英文别名为air potato。黄药（本草原始），山慈姑（植物名实图考），零余子薯蓣（俄、拉、汉种子植物名称），零余薯（广州植物志、海南植物志），黄药子（江苏、安徽、浙江、云南等省药材名），山慈姑（云南楚雄）', '草黄树鸭（学名：\"\"）是分布在热带地区的树鸭属，包括中美洲、南美洲、撒哈拉以南非洲、印度次大陆及美国墨西哥湾沿岸地区。草黄树鸭长48-53厘米。牠们的喙是灰色的，头部及脚都很长，头部及上身呈浅黄色，两侧有些红色，冠深色，背部及双翼呈深灰色。尾巴及双翼上有栗褐色的斑纹，上尾有一白色的半月形，在飞时特别明显。雏鸟两侧对比较低，尾巴颜色也有不同。草黄树鸭很普遍。除了一些地区性的移动外，很多时都是留鸟，而在南欧也会有一些流浪者。牠们会在树枝上筑巢，有时也会在空心树中筑巢或利用其他鸟类的巢。牠们每次会生8-12只蛋。草黄树鸭喜欢栖息在淡水湖、稻田或水塘。牠们多在夜间觅食，主要吃种子及植物的其他部份。草黄树鸭是群居的，可以组成一大群。草黄树鸭是《非洲-欧亚大陆迁徙水鸟保护协定》所保护的物种之一。', '黄喉拟水龟（学名：、）又称柴棺龟、石金钱龟，为泽龟科拟水龟属的爬行动物。分布于中国的安徽、云南、海南、河南、广东、贵州、江西、浙江、福建、广西、香港及越南北部，台湾，日本波照间岛、西表岛、石垣岛及与那国岛，生活于低海拔地区的河流、湖泊等。头部为绿色，有黄色带状纹，上颌橄榄色，下颌黄色；背甲长12～14公分；有三条脊棱，中央一条发达，两侧常不明显，后缘呈锯齿状，灰褐色背面，黄色腹面，散步四角形的黑斑，四肢为橄榄色，具有绿色纵走带状纹；趾间具蹼。材棺龟体格强健，杂食性但偏好肉食，水陆两栖，但较喜欢在水边活动，食物包括叶菜、蟋蟀、面包虫、,鱼虾等。生性胆怯，但略具攻击性，会因为争食而攻击同类或其他龟类，有夜行倾向。雄性尾部粗大，泄殖孔超过背甲边缘，雌龟则尾部细短，泄殖孔距躯体较近。雌龟大于雄龟，每年可产卵1-3次，每次下1-5颗蛋，约65-80天孵化。冬天温度低于20度以下时活动会逐渐减少，最后进入冬眠状态。常见于丘陵地带半山区的山间盆地或河流谷地的水域中，常于附近的小灌丛或草丛中。性情害羞，夜行性乌龟。该物种的模式产地在浙江舟山群岛。在台湾普遍称为「柴棺龟」。', '青蒿（学名：）是菊科蒿属的一种植物。二年生草本。茎直立，上部多分枝，具纵棱线。叶子互生，茎中部的叶子二回羽状分裂，线形小裂片。夏季开花，头状花序半球形，多数，成圆锥状，花管状，外面为雌花，内层为两性花。分布于尼泊尔、印度、日本、越南、朝鲜、缅甸以及中国大陆的江西、辽宁、广西、广东、湖南、河北、安徽、浙江、贵州、山东、吉林、福建、陕西、湖北、四川、河南、江苏、云南等地，生长于海拔300米至2,500米的地区，多生于低海拔、湿润的河岸边砂地、林缘、路旁等、山谷及滨海地区，目前尚未由人工引种栽培。按中国药典，中医中的“青蒿”指的是黄花蒿的地上部分，而不是青蒿。虽然青蒿在中文中与青蒿素名称类似，但是青蒿素并不是从青蒿中提取，而是来自同为蒿属(\"Artemisia\") 的黄花蒿(\"Artemisia annua\")。']
